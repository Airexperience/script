...
document.addEventListener("DOMContentLoaded", function () {
    // Kontroller om vi er på det specifikke link
    if (window.location.href === "http://tunnel.airexperience.dk/admin/?module=reception&do=reservations") {
        ...
        reservationRows.forEach(row => {
            // Find cellen med minutter ved at lede efter tekstindholdet "minutes"
            const minutesCell = Array.from(row.children).find(cell => 
                cell.textContent && cell.textContent.includes("minutes")
            );
